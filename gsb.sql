...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 29 mai 2018 à 12:24
...
CREATE TABLE IF NOT EXISTS `collaborateur` (
  ...
  `COL_LOGIN` varchar(15) DEFAULT NULL,
...
INSERT INTO `collaborateur` (`COL_MATRICULE`, `RAP_NUM`, `COL_NOM`, `COL_PRENOM`, `COL_ADRESSE`, `COL_CP`, `COL_VILLE`, `COL_DATEEMBAUCHE`, `COL_LOGIN`, `COL_MDP`, `SEC_CODE`, `LAB_CODE`) VALUES
('a131', NULL, 'Villechalane', 'Louis', '8 cours Lafontaine', '29000', 'BREST', '1992-12-11', NULL, NULL, NULL, 'SW'),
('a17', NULL, 'Andre', 'David', '1 r Aimon de Chissée', '38100', 'GRENOBLE', '1991-08-26', NULL, NULL, NULL, 'GY'),
('a55', NULL, 'Bedos', 'Christian', '1 r Bénédictins', '65000', 'TARBES', '1987-07-17', NULL, NULL, NULL, 'GY'),
('a93', NULL, 'Tusseau', 'Louis', '22 r Renou', '86000', 'POITIERS', '1999-01-02', NULL, NULL, NULL, 'SW'),
('b13', NULL, 'Bentot', 'Pascal', '11 av 6 Juin', '67000', 'STRASBOURG', '1996-03-11', NULL, NULL, NULL, 'GY'),
('b16', NULL, 'Bioret', 'Luc', '1 r Linne', '35000', 'RENNES', '1997-03-21', NULL, NULL, NULL, 'SW'),
('b19', NULL, 'Bunisset', 'Francis', '10 r Nicolas Chorier', '85000', 'LA ROCHE SUR YON', '1999-01-31', NULL, NULL, NULL, 'GY'),
('b25', NULL, 'Bunisset', 'Denise', '1 r Lionne', '49100', 'ANGERS', '1994-07-03', NULL, NULL, NULL, 'SW'),
('b28', NULL, 'Cacheux', 'Bernard', '114 r Authie', '34000', 'MONTPELLIER', '2000-08-02', NULL, NULL, NULL, 'GY'),
('b34', NULL, 'Cadic', 'Eric', '123 r Caponière', '41000', 'BLOIS', '1993-12-06', NULL, NULL, 'P', 'SW'),
('b4', NULL, 'Charoze', 'Catherine', '100 pl Géants', '33000', 'BORDEAUX', '1997-09-25', NULL, NULL, NULL, 'SW'),
('b50', NULL, 'Clepkens', 'Christophe', '12 r Fédérico Garcia Lorca', '13000', 'MARSEILLE', '1998-01-18', NULL, NULL, NULL, 'SW'),
('b59', NULL, 'Cottin', 'Vincenne', '36 sq Capucins', '5000', 'GAP', '1995-10-21', NULL, NULL, NULL, 'GY'),
('c14', NULL, 'Daburon', 'François', '13 r Champs Elysées', '6000', 'NICE', '1989-02-01', NULL, NULL, 'S', 'SW'),
('c3', NULL, 'De', 'Philippe', '13 r Charles Peguy', '10000', 'TROYES', '1992-05-05', NULL, NULL, NULL, 'SW'),
('c54', NULL, 'Debelle', 'Michel', '181 r Caponière', '88000', 'EPINAL', '1991-04-09', NULL, NULL, NULL, 'SW'),
('d13', NULL, 'Debelle', 'Jeanne', '134 r Stalingrad', '44000', 'NANTES', '1991-12-05', NULL, NULL, NULL, 'SW'),
('d51', NULL, 'Debroise', 'Michel', '2 av 6 Juin', '70000', 'VESOUL', '1997-11-18', NULL, NULL, 'E', 'GY'),
('e22', NULL, 'Desmarquest', 'Nathalie', '14 r Fédérico Garcia Lorca', '54000', 'NANCY', '1989-03-24', NULL, NULL, NULL, 'GY'),
('e24', NULL, 'Desnost', 'Pierre', '16 r Barral de Montferrat', '55000', 'VERDUN', '1993-05-17', NULL, NULL, 'E', 'SW'),
('e39', NULL, 'Dudouit', 'Frédéric', '18 quai Xavier Jouvin', '75000', 'PARIS', '1988-04-26', NULL, NULL, NULL, 'GY'),
('e49', NULL, 'Duncombe', 'Claude', '19 av Alsace Lorraine', '9000', 'FOIX', '1996-02-19', NULL, NULL, NULL, 'GY'),
('e5', NULL, 'Enault-Pascreau', 'Céline', '25B r Stalingrad', '40000', 'MONT DE MARSAN', '1990-11-27', NULL, NULL, 'S', 'GY'),
('e52', NULL, 'Eynde', 'Valérie', '3 r Henri Moissan', '76000', 'ROUEN', '1991-10-31', NULL, NULL, NULL, 'GY'),
('f21', NULL, 'Finck', 'Jacques', 'rte Montreuil Bellay', '74000', 'ANNECY', '1993-06-08', NULL, NULL, NULL, 'SW'),
('f39', NULL, 'Frémont', 'Fernande', '4 r Jean Giono', '69000', 'LYON', '1997-02-15', NULL, NULL, NULL, 'GY'),
('f4', NULL, 'Gest', 'Alain', '30 r Authie', '46000', 'FIGEAC', '1994-05-03', NULL, NULL, NULL, 'GY'),
('g19', NULL, 'Gheysen', 'Galassus', '32 bd Mar Foch', '75000', 'PARIS', '1996-01-18', NULL, NULL, NULL, 'SW'),
('g30', NULL, 'Girard', 'Yvon', '31 av 6 Juin', '80000', 'AMIENS', '1999-03-27', NULL, NULL, 'N', 'GY'),
('g53', NULL, 'Gombert', 'Luc', '32 r Emile Gueymard', '56000', 'VANNES', '1985-10-02', NULL, NULL, NULL, 'GY'),
('g7', NULL, 'Guindon', 'Caroline', '40 r Mar Montgomery', '87000', 'LIMOGES', '1996-01-13', NULL, NULL, NULL, 'GY'),
('h13', NULL, 'Guindon', 'François', '44 r Picotière', '19000', 'TULLE', '1993-05-08', NULL, NULL, NULL, 'SW'),
('h30', NULL, 'Igigabel', 'Guy', '33 gal Arlequin', '94000', 'CRETEIL', '1998-04-26', NULL, NULL, NULL, 'SW'),
('h35', NULL, 'Jourdren', 'Pierre', '34 av Jean Perrot', '15000', 'AURRILLAC', '1993-08-26', NULL, NULL, NULL, 'GY'),
('h40', NULL, 'Juttard', 'Pierre-Raoul', '34 cours Jean Jaurès', '8000', 'SEDAN', '1992-11-01', NULL, NULL, NULL, 'GY'),
('j45', NULL, 'Labouré-Morel', 'Saout', '38 cours Berriat', '52000', 'CHAUMONT', '1998-02-25', NULL, NULL, 'N', 'SW'),
('j50', NULL, 'Landré', 'Philippe', '4 av Gén Laperrine', '59000', 'LILLE', '1992-12-16', NULL, NULL, NULL, 'GY'),
('j8', NULL, 'Langeard', 'Hugues', '39 av Jean Perrot', '93000', 'BAGNOLET', '1998-06-18', NULL, NULL, 'P', 'GY'),
('k4', NULL, 'Lanne', 'Bernard', '4 r Bayeux', '30000', 'NIMES', '1996-11-21', NULL, NULL, NULL, 'SW'),
('k53', NULL, 'Le', 'Noël', '4 av Beauvert', '68000', 'MULHOUSE', '1983-03-23', NULL, NULL, NULL, 'SW'),
('l14', NULL, 'Le', 'Jean', '39 r Raspail', '53000', 'LAVAL', '1995-02-02', NULL, NULL, NULL, 'SW'),
('l23', NULL, 'Leclercq', 'Servane', '11 r Quinconce', '18000', 'BOURGES', '1995-06-05', NULL, NULL, NULL, 'SW'),
('l46', NULL, 'Lecornu', 'Jean-Bernard', '4 bd Mar Foch', '72000', 'LA FERTE BERNARD', '1997-01-24', NULL, NULL, NULL, 'GY'),
('l56', NULL, 'Lecornu', 'Ludovic', '4 r Abel Servien', '25000', 'BESANCON', '1996-02-27', NULL, NULL, NULL, 'SW'),
('m35', NULL, 'Lejard', 'Agnès', '4 r Anthoard', '82000', 'MONTAUBAN', '1987-10-06', NULL, NULL, NULL, 'SW'),
('m45', NULL, 'Lesaulnier', 'Pascal', '47 r Thiers', '57000', 'METZ', '1990-10-13', NULL, NULL, NULL, 'SW'),
('n42', NULL, 'Letessier', 'Stéphane', '5 chem Capuche', '27000', 'EVREUX', '1996-03-06', NULL, NULL, NULL, 'GY'),
('n58', NULL, 'Loirat', 'Didier', 'Les Pêchers cité Bourg la Croix', '45000', 'ORLEANS', '1992-08-30', NULL, NULL, NULL, 'GY'),
('n59', NULL, 'Maffezzoli', 'Thibaud', '5 r Chateaubriand', '2000', 'LAON', '1994-12-19', NULL, NULL, NULL, 'SW'),
('o26', NULL, 'Mancini', 'Anne', '5 r D\'Agier', '48000', 'MENDE', '1995-01-05', NULL, NULL, NULL, 'GY'),
('p32', NULL, 'Marcouiller', 'Gérard', '7 pl St Gilles', '91000', 'ISSY LES MOULINEAUX', '1992-12-24', NULL, NULL, NULL, 'GY'),
('p40', NULL, 'Michel', 'Jean-Claude', '5 r Gabriel Péri', '61000', 'FLERS', '1992-12-14', NULL, NULL, 'O', 'SW'),
('p41', NULL, 'Montecot', 'Françoise', '6 r Paul Valéry', '17000', 'SAINTES', '1998-07-27', NULL, NULL, NULL, 'GY'),
('p42', NULL, 'Notini', 'Veronique', '5 r Lieut Chabal', '60000', 'BEAUVAIS', '1994-12-12', NULL, NULL, NULL, 'SW'),
('p49', NULL, 'Onfroy', 'Den', '5 r Sidonie Jacolin', '37000', 'TOURS', '1977-10-03', NULL, NULL, NULL, 'GY'),
('p6', NULL, 'Pascreau', 'Charles', '57 bd Mar Foch', '64000', 'PAU', '1997-03-30', NULL, NULL, NULL, 'SW'),
('p7', NULL, 'Pernot', 'Claude-Noël', '6 r Alexandre 1 de Yougoslavie', '11000', 'NARBONNE', '1990-03-01', NULL, NULL, NULL, 'SW'),
('p8', NULL, 'Perrier', 'Maître', '6 r Aubert Dubayet', '71000', 'CHALON SUR SAONE', '1991-06-23', NULL, NULL, NULL, 'GY'),
('q17', NULL, 'Petit', 'Jean-Louis', '7 r Ernest Renan', '50000', 'SAINT LO', '1997-09-06', NULL, NULL, NULL, 'GY'),
('r24', NULL, 'Piquery', 'Patrick', '9 r Vaucelles', '14000', 'CAEN', '1984-07-29', NULL, NULL, 'O', 'GY'),
('r58', NULL, 'Quiquandon', 'Joël', '7 r Ernest Renan', '29000', 'QUIMPER', '1990-06-30', NULL, NULL, NULL, 'GY'),
('s10', NULL, 'Retailleau', 'Josselin', '88Bis r Saumuroise', '39000', 'DOLE', '1995-11-14', NULL, NULL, NULL, 'SW'),
('s21', NULL, 'Retailleau', 'Pascal', '32 bd Ayrault', '23000', 'MONTLUCON', '1992-09-25', NULL, NULL, NULL, 'SW'),
('t43', NULL, 'Souron', 'Maryse', '7B r Gay Lussac', '21000', 'DIJON', '1995-03-09', NULL, NULL, NULL, 'SW'),
('t47', NULL, 'Tiphagne', 'Patrick', '7B r Gay Lussac', '62000', 'ARRAS', '1997-08-29', NULL, NULL, NULL, 'SW'),
('t55', NULL, 'Tréhet', 'Alain', '7D chem Barral', '12000', 'RODEZ', '1994-11-29', NULL, NULL, NULL, 'SW'),
('t60', NULL, 'Tusseau', 'Josselin', '63 r Bon Repos', '28000', 'CHARTRES', '1991-03-29', NULL, NULL, NULL, 'GY'),
('zzz', NULL, 'swiss', 'bourdin', NULL, NULL, NULL, '2003-06-18', NULL, NULL, NULL, 'BC');
...
--
-- Structure de la table `decouler`
--

DROP TABLE IF EXISTS `decouler`;
CREATE TABLE IF NOT EXISTS `decouler` (
  `MED_DEPOTLEGAL` varchar(10) NOT NULL,
  `ECHAN_CODE` int(11) DEFAULT NULL,
...
INSERT INTO `delegue` (`COL_MATRICULE`, `REG_CODE`) VALUES
('a17', 'RA'),
('a55', 'RO'),
('b25', 'PL'),
('b34', 'CE'),
...
CREATE TABLE IF NOT EXISTS `distribuer` (
  `RAP_NUM` int(11) DEFAULT NULL,
  `ECHAN_CODE` int(11) DEFAULT NULL,
  `DIS_QTE` int(11) DEFAULT NULL,
  KEY `ECHAN_CODE` (`ECHAN_CODE`),
  KEY `RAP_NUM` (`RAP_NUM`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `distribuer` (`RAP_NUM`, `ECHAN_CODE`, `DIS_QTE`) VALUES
(11, 7, 5),
(11, 5, 2),
(11, 22, 1);
...
CREATE TABLE IF NOT EXISTS `echantillon` (
  `ECHAN_CODE` int(11) NOT NULL AUTO_INCREMENT,
  `ECHAN_NOM` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`ECHAN_CODE`)
...
INSERT INTO `echantillon` (`ECHAN_CODE`, `ECHAN_NOM`) VALUES
(1, 'TRIMYCINE'),
(2, 'ADIMOL'),
(3, 'AMOPIL'),
(4, 'AMOXAR'),
(5, 'AMOXI Gé'),
(6, 'APATOUX Vitamine C'),
(7, 'BACTIGEL'),
(8, 'BACTIVIL'),
(9, 'BIVALIC'),
(10, 'CARTION'),
...
CREATE TABLE IF NOT EXISTS `motif` (
  `MOTIF_CODE` int(11) NOT NULL,
  `MOTIF_LIBELLE` varchar(50) DEFAULT NULL,
...
INSERT INTO `motif` (`MOTIF_CODE`, `MOTIF_LIBELLE`) VALUES
(1, 'Régularisation'),
(2, 'Nouveau Produit'),
(3, 'Nouvelle Législation'),
(4, 'Baisse de Prescription'),
(5, 'Sollicitation du Médecin'),
(6, 'Autres');

-- --------------------------------------------------------

--
-- Structure de la table `motiver`
--

DROP TABLE IF EXISTS `motiver`;
CREATE TABLE IF NOT EXISTS `motiver` (
  `MOTIF_CODE` int(11) NOT NULL,
  `RAP_NUM` int(11) NOT NULL,
  `COL_MATRICULE` varchar(10) NOT NULL,
  PRIMARY KEY (`MOTIF_CODE`,`RAP_NUM`,`COL_MATRICULE`),
  KEY `RAP_NUM` (`RAP_NUM`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `motiver`
--

INSERT INTO `motiver` (`MOTIF_CODE`, `RAP_NUM`, `COL_MATRICULE`) VALUES
(1, 7, 'a131'),
(2, 11, 'a131'),
(3, 6, 'a17'),
(5, 5, 'a131'),
...
CREATE TABLE IF NOT EXISTS `notedefrais` (
  ...
  `MontantRepasMidi` float NOT NULL,
  `MontantRepasSoir` float NOT NULL,
  `PrixNuit` float NOT NULL,
  `MontantTotalHF` float NOT NULL,
  `NbJustificatif` float NOT NULL,
...
INSERT INTO `notedefrais` (`id`, `PRA_NOM`, `dateVisite`, `MontantRepasMidi`, `MontantRepasSoir`, `PrixNuit`, `MontantTotalHF`, `NbJustificatif`, `MontantTotal`) VALUES
(1, 'Andre', '2018-04-03', 4, 4, 4, 16, 0, 16.5),
(2, 'Leroux', '2018-04-03', 4, 4, 6, 18, 4, 18.5);
...
CREATE TABLE IF NOT EXISTS `praticien` (
  ...
  `TYP_CODE` varchar(3) NOT NULL DEFAULT '',
...
(3, 'Delahaye', 'Andr', '36 av 6 Juin', '25000', 'BESANCON', 185.79, 'PS', '25'),
(4, 'Leroux', 'Andr', '47 av Robert Schuman', '60000', 'BEAUVAIS', 172.04, 'PH', '60'),
...
(11, 'Mar?ais-Lefebvre', 'Bertrand', '86Bis r Basse', '67000', 'STRASBOURG', 450.96, 'MH', '67'),
(12, 'Boscher', 'Bruno', '94 r Falaise', '10000', 'TROYES', 356.14, 'MV', '10'),
(13, 'Morel', 'Catherine', '21 r Chateaubriand', '75000', 'PARIS', 379.57, 'PS', '75'),
(14, 'Guivarch', 'Chantal', '4 av G?n Laperrine', '45000', 'ORLEANS', 114.56, 'PH', '45'),
(15, 'Bessin-Grosdoit', 'Christophe', '92 r Falaise', '6000', 'NICE', 222.06, 'PO', '06'),
(16, 'Rossa', 'Claire', '14 av Thi', '6000', 'NICE', 529.78, 'MH', '06'),
(17, 'Cauchy', 'Denis', '5 av Ste Th?r?se', '11000', 'NARBONNE', 458.82, 'MV', '11'),
(18, 'Gaff', 'Dominique', '9 av 1?re Arm?e Fran?aise', '35000', 'RENNES', 213.4, 'PS', '35'),
(19, 'Guenon', 'Dominique', '98 bd Mar Lyautey', '44000', 'NANTES', 175.89, 'PH', '44'),
(20, 'Pr?vot', 'Dominique', '29 r Lucien Nelle', '87000', 'LIMOGES', 151.36, 'PO', '87'),
(21, 'Houchard', 'Eliane', '9 r Demolombe', '49100', 'ANGERS', 436.96, 'MH', '49'),
(22, 'Desmons', 'Elisabeth', '51 r Berni?res', '29000', 'QUIMPER', 281.17, 'MV', '29'),
...
(27, 'Lefebvre', 'Fr?d?ric', '2 pl Wurzburg', '55000', 'VERDUN', 573.63, 'MV', '55'),
(28, 'Lem', 'Fr?d?ric', '29 av 6 Juin', '56000', 'VANNES', 326.4, 'PS', '56'),
(29, 'Martin', 'Fr?d?ric', 'B?t A 90 r Bayeux', '70000', 'VESOUL', 506.06, 'PH', '70'),
(30, 'Marie', 'Fr?d?rique', '172 r Caponi?re', '70000', 'VESOUL', 313.31, 'PO', '70'),
(31, 'Rosenstech', 'Genevi?ve', '27 r Auvergne', '75000', 'PARIS', 366.82, 'MH', '75'),
...
(34, 'Blanchais', 'Guy', '30 r Authie', '8000', 'SEDAN', 502.48, 'PH', '08'),
...
(38, 'Marie', 'Jean-Claude', '26 r H?rouville', '69000', 'LYON', 120.1, 'PS', '69'),
(39, 'Maury', 'Jean-Fran?ois', '5 r Pierre Girard', '71000', 'CHALON SUR SAONE', 13.73, 'PH', '71'),
(40, 'Dennel', 'Jean-Louis', '7 pl St Gilles', '28000', 'CHARTRES', 550.69, 'PO', '28'),
(41, 'Ain', 'Jean-Pierre', '4 r?sid Olympia', '2000', 'LAON', 5.59, 'MH', '02'),
...
(45, 'Phan', 'J?rôme', '9 r Clos Caillet', '79000', 'NIORT', 451.61, 'PO', '79'),
(46, 'Riou', 'Line', '43 bd G?n Vanier', '77000', 'MARNE LA VALLEE', 193.25, 'MH', '77'),
...
(50, 'Laforge', 'Marc', '5 r?sid Prairie', '50000', 'SAINT LO', 265.05, 'PO', '50'),
...
(55, 'Plantet-Besnier', 'Nicole', '10 av 1?re Arm?e Fran?aise', '86000', 'CHATELLEREAULT', 369.94, 'PO', '86'),
...
(59, 'Chanteloube', 'Patrice', '14 av Thi', '13000', 'MARSEILLE', 478.01, 'PH', '13'),
(60, 'Lecuirot', 'Patrice', 'r?sid St P?res 55 r Pigaci?re', '54000', 'NANCY', 239.66, 'PO', '54'),
...
(63, 'Boireaux', 'Philippe', '14 av Thi', '10000', 'CHALON EN CHAMPAGNE', 454.48, 'PS', '10'),
(64, 'Cendrier', 'Philippe', '7 pl St Gilles', '12000', 'RODEZ', 164.16, 'PH', '12'),
(65, 'Duhamel', 'Philippe', '114 r Authie', '34000', 'MONTPELLIER', 98.62, 'PO', '65'),
(66, 'Grigy', 'Philippe', '15 r M?lingue', '44000', 'CLISSON', 285.1, 'MH', '44'),
(67, 'Linard', 'Philippe', '1 r Albert de Mun', '81000', 'ALBI', 486.3, 'MV', '81'),
(68, 'Lozier', 'Philippe', '8 r Gaillon', '31000', 'TOULOUSE', 48.4, 'PS', '31'),
(69, 'Dech?tre', 'Pierre', '63 av Thi', '23000', 'MONTLUCON', 253.75, 'PH', '23'),
(70, 'Goessens', 'Pierre', '22 r Jean Romain', '40000', 'MONT DE MARSAN', 426.19, 'PO', '40'),
(71, 'Lem?nager', 'Pierre', '39 av 6 Juin', '57000', 'METZ', 118.7, 'MH', '57'),
(72, 'N', 'Pierre', '39 av 6 Juin', '82000', 'MONTAUBAN', 72.54, 'MV', '82'),
(73, 'Guyot', 'Pierre-Laurent', '43 bd G?n Vanier', '48000', 'MENDE', 352.31, 'PS', '48'),
...
(77, 'Guyot', 'St?phane', '26 r H?rouville', '46000', 'FIGEAC', 28.85, 'MV', '46'),
(78, 'Delposen', 'Sylvain', '39 av 6 Juin', '27000', 'DREUX', 292.01, 'PS', '27'),
(79, 'Rault', 'Sylvie', '15 bd Richemond', '2000', 'SOISSON', 526.6, 'PH', '02'),
(80, 'Renouf', 'Sylvie', '98 bd Mar Lyautey', '88000', 'EPINAL', 425.24, 'PO', '88'),
(81, 'Alliet-Grach', 'Thierry', '14 av Thi', '7000', 'PRIVAS', 451.31, 'MH', '07'),
...
(84, 'Bobichon', 'Tristan', '219 r Caponi?re', '9000', 'FOIX', 218.36, 'PH', '09'),
(85, 'Duchemin-Laniel', 'V?ronique', '130 r St Jean', '33000', 'LIBOURNE', 265.61, 'PO', '33'),
(86, 'Laurent', 'Youn', '34 r Demolombe', '53000', 'MAYENNE', 496.1, 'MH', '53');
...
INSERT INTO `rapport_visite` (`COL_MATRICULE`, `RAP_NUM`, `PRA_NUM`, `RAP_DATE`, `RAP_BILAN`) VALUES
('a131', 5, 23, '2002-04-18 00:00:00', 'Médecin curieux, à recontacer en décembre pour réunion'),
('a131', 7, 41, '2003-03-23 00:00:00', 'RAS\r\nChangement de tel : 05 89 89 89 89'),
('a17', 6, 4, '2003-05-21 00:00:00', 'Changement de direction, redéfinition de la politique médicamenteuse, recours au générique'),
('a131', 9, 20, '2017-11-29 16:21:20', 'autre chose blablabla'),
('a131', 8, 12, '2017-11-29 16:20:56', 'autre chose ouai ouai'),
('a131', 10, 6, '2017-11-30 17:59:26', 'voila voila voila'),
('a131', 11, 7, '2017-11-30 18:13:34', 'Bbrilliance cest vraiment super'),
('11', 1, 11, '2018-04-18 11:24:18', 'sc'),
('11', 2, 11, '2018-04-18 11:24:20', 'sc'),
('11', 3, 11, '2018-04-18 11:24:22', 'sc'),
('11', 4, 11, '2018-04-18 11:24:35', 'sc'),
('11', 5, 11, '2018-04-18 11:25:48', 'sc'),
('11', 6, 11, '2018-04-18 11:25:56', 'sc'),
('11', 7, 11, '2018-04-18 11:27:21', 'scdede'),
('11', 8, 11, '2018-04-18 11:27:46', 'scdede'),
('11', 9, 11, '2018-04-18 11:29:58', 'scdede'),
('11', 10, 11, '2018-04-18 11:30:13', 'scdede');
...
--
-- Structure de la table `remplacer`
--

DROP TABLE IF EXISTS `remplacer`;
CREATE TABLE IF NOT EXISTS `remplacer` (
  `PRA_NUM` int(11) NOT NULL,
  `REM_RAISON` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`PRA_NUM`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `representant` (
  ...
  PRIMARY KEY (`COL_MATRICULE`,`SEC_LIBELLE`),
  KEY `SEC_LIBELLE` (`SEC_LIBELLE`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `representant` (`COL_MATRICULE`, `SEC_LIBELLE`, `LAB_CODE`) VALUES
('b34', 'Paris centre', 'SW'),
('c14', 'Sud', 'SW'),
('d51', 'Est', 'GY'),
('e24', 'Est', 'SW'),
...
CREATE TABLE IF NOT EXISTS `travailler` (
  ...
  PRIMARY KEY (`JJMMAA`,`COL_MATRICULE`,`REG_CODE`),
  KEY `COL_MATRICULE` (`COL_MATRICULE`),
  KEY `REG_CODE` (`REG_CODE`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `visiteur` (`COL_MATRICULE`, `LAB_CODE`) VALUES
('a131', 'SW'),
('a17', 'GY'),
('a55', 'GY'),
('a93', 'SW'),
